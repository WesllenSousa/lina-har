...
//    System.out.println("Memory: " + ((runtime.totalMemory() - mem) / (1048576l)) + " MB (rough estimate)");
    ...
    /**
     * the depth of the tree to use for bulk loading: depth 1 => 8^1 buckets
     * depth 2 => 8^2 buckets ... depth i => symbols ^ i buckets
     *
     * @param count
     * @param chunkSize
     * @return
...
//    index.writeToDisk(location);
    ...
    static class SerializedStreams {
        ...
        /**
         * Adds a time series to the corresponding queue and writes the bucket
         * to disk if the bucket exceeds minWriteToDiskLimit elements
         */
