 ...
 */
public class BOSSMDClassification {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ClassifierMD bossmd = new BOSSVSMDClassifier(trainSamples, testSamples);
            ClassifierMD.Score scoreMD = bossmd.eval();
            System.out.println(s + ";" + scoreMD.toString());
            
        } catch (IOException ex) {
            Logger.getLogger(BOSSMDClassification.class.getName()).log(Level.SEVERE, null, ex);
        }
