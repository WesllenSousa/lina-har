...
/**
 * Implementation of the SFATrie for time series subsequence-search using SFA.
 *
 * See publication: Schäfer, P., Högqvist, M.: SFA: a symbolic fourier
 * approximation and index for similarity search in high dimensional datasets.
 * In: EDBT, ACM (2012)
 *
 */
...
//    this.quantization.printBins();
     ...
     * @param minDepth The minimal depth of the trie (i.e. all nodes start with
     * this prefix length) This is needed for bulk loading.
    ...
    /**
     * Re-insert a node at the given prefix and at node 'node'
     *
     * @param nodeToInsert
     * @param path
     * @param index
     ...
     * Merge two trees
     *
     * Used for bulk loading. Tries at disjoint prefices are constructured and
     * merged
     *
     * @param tree
     */
    ...
    /**
     * Retrieves the leaf node to 'path'. If there is no exact leaf node, it
     * returns any sibling node on the path.
     *
     * @param path
     * @return
     */
    ...
    /**
     * Returns the total number of time series in the trie
     *
     * @return
     */
    public int getSize() {
    ...
    public class SFANode implements Serializable {
        ...
        /**
         * Returns the total number of time series of the node and all its
         * children
         *
         * @return
         */
