...
public class SFASupervised extends SFA {
     ...
     * word corresponds to one Fourier value. As opposed to the normal SFA
     * model, here characters correspond to those Fourier values that are most
    ...
    /**
     * calculate ANONVA F-stat compare :
