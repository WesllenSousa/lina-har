...
public abstract class Classifier {
    ...
    public Classifier(String train, String test) throws IOException {
        this.train = train;
        this.test = test;

        this.trainSamples = TimeSeriesLoader.loadHorizontalData(train, " ", true);
        if (test != null) {
            this.testSamples = TimeSeriesLoader.loadHorizontalData(test, " ", true);
        } else {
