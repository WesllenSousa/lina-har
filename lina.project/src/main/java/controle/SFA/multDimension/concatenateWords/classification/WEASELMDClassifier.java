...
import controle.SFA.multDimension.concatenateWords.transformation.WEASELMD;
import controle.SFA.multDimension.concatenateWords.transformation.WEASELMD.BagOfBigrams;
import controle.SFA.multDimension.concatenateWords.transformation.WEASELMD.Dictionary;
...
public class WEASELMDClassifier extends MDClassifier {
    ...
    public WEASELMDClassifier(TimeSeriesMD[] train, TimeSeriesMD[] test) {
        super(train, test);
        Linear.resetRandom();
    }
    ...
    @Override
    public Double[] predict(TimeSeriesMD[] samples) {
    ...
    protected WEASELModel fitWeasel(final TimeSeriesMD[] samples) {
        try {
            int maxCorrect = -1;
            int bestF = -1;
