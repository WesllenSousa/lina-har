...
import controle.stringsimilarity.interfaces.NormalizedStringSimilarity;
 ...
 * that a far from each other. Jaro-Winkler was developed in the area of record
 * linkage (duplicate detection) (Winkler, 1990). It returns a value in the
 * interval [0.0, 1.0]. The distance is computed as 1 - Jaro-Winkler similarity.
 *
