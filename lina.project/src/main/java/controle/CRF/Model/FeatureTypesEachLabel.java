...
public class FeatureTypesEachLabel extends FeatureTypes {
    ...
    public boolean startScanFeaturesAt(controle.CRF.CRF.DataSequence data, int prevPos,
            int pos) {
        stateId = numStates;
    ...
    public boolean startScanFeaturesAt(controle.CRF.CRF.DataSequence data,
            int pos) {
        stateId = numStates;
    ...
    public void next(controle.CRF.Model.FeatureImpl f) {
        f.copy(featureImpl);
        nextCopyDone(f);
    }
    protected void nextCopyDone(controle.CRF.Model.FeatureImpl f) {
        f.yend = stateId;
