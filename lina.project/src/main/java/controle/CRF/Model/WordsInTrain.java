...
/**
 *
 * This is created by FeatureGenTypes and is available for any featureTypes
 * class to use. What it does is provide you counts of the number of times a
 * word occurs in a state.
 *
 * @author Sunita Sarawagi
 *
 */
