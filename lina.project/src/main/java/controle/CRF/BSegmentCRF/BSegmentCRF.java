 ...
 * @version 1.3
 *
 * BSegmentCRF (A significantly faster version of Semi-CRFs that employs a
 * compact feature representation) for fast training and inference of
 * semi-Markov models.
 */
...
import controle.CRF.CRF.SegmentCRF;
