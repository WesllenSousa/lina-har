...
import controle.CRF.CRF.Feature;
import controle.CRF.CRF.LogSparseDoubleMatrix1D;
import controle.CRF.CRF.RobustMath;
import controle.CRF.CRF.FeatureGenCache;
...
public class FeatureStore {
    ...
    class Iter {
        ...
        public BFeature next() {
            if (currentType == 4) {
                featureImpl.init(viter.next(),s,s+currentLen);
            } else {
                featureImpl.init(viter.next(),s,s+currentLen,currentType);
            }
            advance();
            return featureImpl;
        }
