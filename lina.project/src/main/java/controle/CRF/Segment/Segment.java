...
import controle.CRF.BSegment.BFeatureGenImpl;
import controle.CRF.BSegmentCRF.BSegmentCRF;
import controle.CRF.CRF.CRF;
import controle.CRF.CRF.DataIter;
import controle.CRF.CRF.FeatureGenerator;
import controle.CRF.CRF.NestedCRF;
import controle.CRF.CRF.SegmentDataSequence;
import controle.CRF.CRF.Segmentation;
import controle.CRF.CRF.Util;
import controle.CRF.Model.FeatureGenImpl;
import controle.CRF.Model.NestedFeatureGenImpl;
import controle.CRF.Utils.Options;
...
public class Segment {
    ...
    public static void main(String argv[]) throws Exception {
        argv = new String[] {"all", "-f", "samples/us50.conf"};
