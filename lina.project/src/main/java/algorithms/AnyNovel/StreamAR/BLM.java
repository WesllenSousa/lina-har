package algorithms.AnyNovel.StreamAR;
...
public class BLM implements Serializable {
    ...
    public BLM(BLM baseModel) {
        ...
        this.m_classesWithClusters = new ArrayList<>(baseModel.m_classesWithClusters.size());
    ...
    public ArrayList<Integer> driftClassID = new ArrayList<>();
    ...
    public String adaptationComponent(Instances nInst) throws Throwable {
        ...
        else if (this.suspNovelInstances.numInstances() == 0) {
            // Chcek if empty
            boolean coF = instancesCorrelated2(newInst, justPredicted);
            if (this.justPredicted.numInstances() == 0 || (this.justPredicted.numInstances() != 0 && !coF)) {
                if (reset) {
    ...
    private void addNovelClass(Instances suspNovelInstances, String label) throws Exception {
        ...
        ALStats += "\n create novel class \n";
        ALcases[2]++;
        ArrayList<Instances> classSubClusters = new ArrayList<>();
    ...
    public String updateModelConceptEvolution(NovelPredection pred) {
        String s = "";
        ...
        if (pred.getNoveltyType().contains("Fn")) {
            ...
            try {
                ...
                System.out.println("updateModelFn: " + ex);
            }
    ...
    public String updateModelConceptEvolution_Unknown(Instances inst, NovelPredection pred) {
        String s = "";
        unkFlag = true;
        double purity = Double.parseDouble(pred.getClassTrueLabel()[1]);
        purity /= pred.getClassSize();
        ...
        try {
            ...
            System.out.println("updateCSWSCModel: " + ex);
        }
        unkFlag = false;
        return s;
    ...
    public void setParameters(HashMap<String, String> parameters) {
        ...
        } else if (compatible(slackTxt, this)) {
