package algorithms.SAX.saxvsm.text;
...
/**
 * Implements a word bag. Word bag is the container for pairs word-frequency. It
 * is not text, it is usually a processed text.
 *
 * @author psenin
 *
 */
public class WordBag implements Cloneable {
    ...
    /**
     * Implements merge operation for this bag with some other bag. Resulting
     * words set is the union of words from two bags, and resulting frequencies
     * are the sum of two frequencies.
     *
