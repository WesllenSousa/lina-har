package algorithms.SAX.saxvsm.cluster;

import algorithms.SAX.saxvsm.text.CosineDistanceMatrix;
...
public class Cluster {
     ...
     * @return The distance between clusters based on the distances and the
     * linkage.
     */
    ...
    /**
     * Returns the NEWICK format representation of this node cluster. You still
     * need to take it in parenthesis if this is your ROOT.
     *
