package algorithms.SAX.saxvsm.direct;
...
/**
 * Implements a cross-validation DIRECT-based procedure for SAX-VSM parameters
 * optimization.
 *
 * The direct code was taken from JCOOL (Java COntinuous Optimization Library),
 * and altered for SAX-VSM needs.
 *
 * @see
 * <a href="https://github.com/dhonza/JCOOL/wiki">https://github.com/dhonza/JCOOL/wiki</a>
 *
 */
