...
import algorithms.SFA.index.SFATrie;
import algorithms.SFA.index.SortedListMap;
...
import algorithms.SFA.sfa_test.index.SFATrieTest;
...
public class SFABulkLoadTest {
  ...
  private TimeSeries getTimeSeries(int i, int n) {
    return TimeSeriesLoader2.generateRandomWalkData(n, new Random(i));
  }
  ...
  public void testBulkLoadSubsequenceMatching() throws IOException {
    ...
    TimeSeries[] timeSeries2 = TimeSeriesLoader2.readSamplesQuerySeries(
